...
I used React.js but I believe regular HTML, CSS and JavaScript would have been just fine. I made the API remote, but I made one local as well to show whats in the schema.
